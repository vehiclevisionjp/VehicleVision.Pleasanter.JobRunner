...
Use the `jobrunner.service` template from [Debian](debian.md). On SELinux-enabled servers, allow nginx to proxy to the app:
...
Use the reverse proxy template from [Debian](debian.md). Confirm firewall rules:
